...
BEGIN_MESSAGE_MAP(CSN2019111396View, CScrollView)
	...
	ON_COMMAND(IDM_EDGE_PREWITT, &CSN2019111396View::OnEdgePrewitt)
	ON_COMMAND(IDM_EDGE_SOBEL, &CSN2019111396View::OnEdgeSobel)
	ON_COMMAND(IDM_SHARPENING_LAPLACIAN, &CSN2019111396View::OnSharpeningLaplacian)
	ON_COMMAND(IDM_BINAR_OTZU, &CSN2019111396View::OnBinarOtzu)
	ON_COMMAND(IDM_BINAR_ADAP, &CSN2019111396View::OnBinarAdap)
	ON_COMMAND(IDM_SMOOTHING_BOX, &CSN2019111396View::OnSmoothingBox)
END_MESSAGE_MAP()
...
void CSN2019111396View::OnEdgePrewitt()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CSN2019111396Doc* pDoc = GetDocument();	//도큐먼트 클래스를 참조하기 위해
...
void CSN2019111396View::OnEdgeSobel()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CSN2019111396Doc* pDoc = GetDocument();	//도큐먼트 클래스를 참조하기 위해
	ASSERT_VALID(pDoc);						//주소를 가져옴
...
void CSN2019111396View::OnSharpeningLaplacian()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CSN2019111396Doc* pDoc = GetDocument();	//도큐먼트 클래스를 참조하기 위해
	ASSERT_VALID(pDoc);						//주소를 가져옴
...
void CSN2019111396View::OnBinarOtzu()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	// TODO: 여기에 구현 코드 추가.
	CSN2019111396Doc* pDoc = GetDocument();
...
void CSN2019111396View::OnBinarAdap()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CSN2019111396Doc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CSN2019111396View::OnSmoothingBox()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CSN2019111396Doc* pDoc = GetDocument();	//도큐먼트 클래스를 참조하기 위해
	ASSERT_VALID(pDoc);						//주소를 가져옴
