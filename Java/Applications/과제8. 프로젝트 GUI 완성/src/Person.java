...
public class Person implements java.io.Serializable {
	...
	public void writeMyField(DataOutputStream fos)throws Exception{	 // 직렬화하면서 사용되지 않음	
		try{
			fos.writeUTF(name);
	...
	public void readMyField(DataInputStream fis)throws Exception{ // 직렬화하면서 사용되지 않음
		try {
				name = fis.readUTF();
